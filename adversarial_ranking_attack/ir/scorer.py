...
model_dir = os.path.dirname(os.path.dirname(os.path.dirname(curdir)))+"/model_hub"
...
class SentenceScorer(object):
    def __init__(self, device):
        self.lm_model = GPT2PerpModel.from_pretrained(model_dir+'/gpt2')
        self.tokenizer = GPT2Tokenizer.from_pretrained(model_dir+'/gpt2')
